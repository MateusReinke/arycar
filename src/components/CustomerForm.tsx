              ...
              <div>
                ...
                {loadingBrands ? (
                  ...
                  <>
                    ...
                    {selectedBrandCode === OTHER_BRAND_CODE && (
                      <Input
                        className="mt-2"
                        value={brand}
                  ...
                  <>
                    ...
                    >
                      ...
                      <SelectContent className="max-h-60">
                        ...
                        {selectedBrandCode && selectedBrandCode !== OTHER_BRAND_CODE && (
                          <SelectItem value={OTHER_MODEL_CODE}>Outro</SelectItem>
                        )}
                      </SelectContent>
                    </Select>
                    {(selectedModelCode === OTHER_MODEL_CODE || selectedBrandCode === OTHER_BRAND_CODE) && (
                      <Input
                        className="mt-2"
                        value={model}
